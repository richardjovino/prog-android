...
import 'package:app11/dados.dart';
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (BuildContext context) {
          return Dados(valueNome: infoname, valueIdade: infoidade, valueSexo: drop, valueEscolaridade: drop1, valueLimit: valor1, valueBrasil: valor2);
        },
      ),
    );
  }
